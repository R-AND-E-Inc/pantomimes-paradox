...
Records of how earlier packages became this one. They explain decisions; they issue no instructions.

- `consolidation-map.md` — how Project Foundry's sixteen commands and obligations were consolidated into the ten `work-*` skills (process 1.0.0 / 1.1.0).
- `process-1.1-amendment.md` — practical judgment before correction loops and coordinator-led delivery (process 1.1.0).
